...
do
  ...
  do
    ...
    for((k=0;k<3;k++))
    do
      # echo "/*----------------------- MatrixCopy_A57_1_dop1: $k th Begin! -----------------------*/" >> Process.txt
      # export XITAO_LAYOUT_PATH=./a1; ./benchmarks/syntheticDAGs/synbench 3 0 10240 0 1 0 100 0 1 >> MC_10240_A57_1_dop1_${emcfreq}_${freq}_${k}.txt
      # # ./Test/MatrixCopy_10240_A57_1_${emcfreq}_${freq}_${k}.txt
      # sleep 5
      # echo "/*----------------------- MatrixCopy_A57_1_dop4: $k th Begin! -----------------------*/" >> Process.txt
      # export XITAO_LAYOUT_PATH=./a1; ./benchmarks/syntheticDAGs/synbench 3 0 10240 0 1 0 100 0 99 > MC_10240_A57_1_dop99_${emcfreq}_${freq}_${k}.txt
      # sleep 5
      # export XITAO_LAYOUT_PATH=./a2; ./benchmarks/syntheticDAGs/synbench 3 0 10240 0 1 0 100 0 99 > MC_10240_A57_2_dop99_${emcfreq}_${freq}_${k}.txt
      # sleep 5
      # export XITAO_LAYOUT_PATH=./a3; ./benchmarks/syntheticDAGs/synbench 3 0 10240 0 1 0 100 0 99 > MC_10240_A57_3_dop99_${emcfreq}_${freq}_${k}.txt
      # sleep 5
      export XITAO_LAYOUT_PATH=./a4; ./benchmarks/syntheticDAGs/synbench 3 0 10240 0 1 0 100 0 99 > MC_10240_A57_4_dop99_${emcfreq}_${freq}_${k}.txt
      sleep 5
      # echo "/*----------------------- MM	100.00%	+	MC	0.00% - Denver_1: $k th Begin! -----------------------*/" >> Process.txt
      # export XITAO_LAYOUT_PATH=./ptt_layout_d2; ./benchmarks/syntheticDAGs/synbench 3 128 4096 0 2 4000 0 0 1 > Denver_2_${emcfreq}_${freq}_${k}.txt
      # sleep 2
    done
  done
done
