...
// Needs to find out the task type ??????
  ...
  infile1.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MINMIN_MatMul.txt");
  while(std::getline(infile1, token)) {
    std::istringstream line(token);
    int ii = 0;
    int pwidth = 0;
  ...
  infile.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MAXMAX_Copy.txt");
  while(std::getline(infile, token)) {
    std::istringstream line(token);
    int ii = 0;
    int pwidth = 0;
  ...
  infile.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MAXMAX_Stencil.txt");
  while(std::getline(infile, token)) {
    std::istringstream line(token);
    int ii = 0;
    int pwidth = 0;
  ...
  infile1.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MINMIN_Stencil.txt");
  while(std::getline(infile1, token)) {
    std::istringstream line(token);
    int ii = 0;
    int pwidth = 0;
  ...
  if(denver_freq == 0 && a57_freq == 0){
    ...
    infile2.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MAXMAX_Stencil.txt");
  }
  if(denver_freq == 1 && a57_freq == 0){
    ...
    infile2.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MINMAX_Stencil.txt");
  }
  if(denver_freq == 0 && a57_freq == 1){
    ...
    infile2.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MAXMIN_Stencil.txt");
  }
  if(denver_freq == 1 && a57_freq == 1){
    infile.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MINMIN_MatMul.txt");
    infile1.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MINMIN_Copy.txt");
    infile2.open("/home/nvidia/Work_1/ERASE_TACO/PowerProfile/TX2_MINMIN_Stencil.txt");
  }
